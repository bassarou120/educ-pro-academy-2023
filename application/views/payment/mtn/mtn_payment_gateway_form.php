...
<div id="buynow" style="height: 45px;">
    <button class="stripe-button payment-button float-right" id="stripePayButton"><?php echo "mtn--".get_phrase("pay_with_stripe"); ?></button>
</div>
...
var createCheckoutSession = function (stripe) {
    return fetch("<?= site_url('home/stripe_checkout'); ?>", {
        method: "POST",
        headers: {

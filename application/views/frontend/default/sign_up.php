...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3 login-form1 hidden ">
...
<!--                    </div>-->
        ...
        <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3 register-form1  ">

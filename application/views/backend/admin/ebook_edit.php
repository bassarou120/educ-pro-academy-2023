                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" data-toggle="select2"
                                                        ...
                                                        <?php $title = $this->ebook_model->get_ebook_categories($ebook['category_id'])->row('title'); ?>
                                                        <?php foreach($this->ebook_model->get_ebook_categories()->result_array() as $category): ?>
                                                        <option value="<?php echo $ebook['category_id']; ?>"
                                                            <?php if($category['title'] == $title){ echo 'selected';} ?>>

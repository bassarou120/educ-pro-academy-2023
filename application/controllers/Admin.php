...
class Admin extends CI_Controller
{
    ...
    public function payment_settings($param1 = "")
    {
        ...
        if ($param1 == 'mtn_settings') {


            $this->crud_model->update_mtn_settings();
            redirect(site_url('admin/payment_settings'), 'refresh');
        }


        if ($param1 == 'fedapay_settings') {


            $this->crud_model->update_fedapay_settings();
            redirect(site_url('admin/payment_settings'), 'refresh');
        }
        ...
        if ($param1 == 'paydunya_settings') {

//            var_dump("test");
//            die();
            $this->crud_model->update_paydunya_settings();
            redirect(site_url('admin/payment_settings'), 'refresh');
        }
